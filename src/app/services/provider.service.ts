...
const API_URL = SERVER_NAME + "/doclabWeb/patient/";
const IMG_URL = SERVER_NAME + "/doclabWeb/uploads/";
const EMPTYIMG_URL = SERVER_NAME + "/doclabWeb/patient/uploads/empty/empty-avatar.jpg";
const ICON_URL = SERVER_NAME + "/doclabWeb/uploads/icons/";
const LOGIN_URL = SERVER_NAME + "/doclabWeb/patient/login.php";
